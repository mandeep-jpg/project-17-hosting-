...
function pinkCyclists(){
  ...
  opponentPink.scale=0.06
  opponentPink.setLifetime=170
...
function yellowCyclists(){
  ...
  opponentYellow.scale =0.06
  opponentYellow.setLifetime=170
...
function redCyclists(){
  ...
  opponentRed.scale=0.06
  opponentRed.setLifetime=170
